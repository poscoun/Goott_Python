...
print(plus, minus, multiple, divid, square, remainder)
...
# 파이썬에서는 실수는 정수와 부동소수점 이라는 개념으로 정의.
...
print('-----------------------------------------------')
# 파이썬에서는 숫자를 사용할 때 다음과 같이 경우를 나눠서 사용
...
# 8진수(Octal) 생성 : 숫자가 0o 또는 0O (숫자 0 +알파벳 소문자 o 또는 대문자 O)로 시작하면됨
octal = 0o10
